...
export const AddressForm = ({ countries, userStoreAddress = {} }: Props) => {
  ...
  const onSubmit: SubmitHandler<FormAddressInputs> = async (data) => {
    console.log({ data });
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col mb-2 sm:mt-1">
        ...
        <button
          type="submit"
          disabled={!isValid} // Se habilita cuando el formulario es válido
          className={clsx({
            "btn-primary": isValid,
            "bg-gray-950 text-white px-4 py-2 rounded-md cursor-not-allowed opacity-50":
              !isValid,
          })}
        >
          Siguiente
